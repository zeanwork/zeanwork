...
$this->pageTitle = 'Datasource não encontrado';

?>

<p>O datasource solicitado não foi encontrado.
Verifique se existe o arquivo <code><?php echo $data['datasource']; ?></code> em <code>Zeanwork/Datasource/</code>
</p>
<br />
<div style="text-align:right; font-size:10px; color:#999">
	Se você quiser personalizar essa mensagem de erro, crie o arquivo <code style="color:#999">datasource.<?php echo Configure::read('defaultExtension') ?>.php</code> em <code style="color:#999">App/Views/Errors/</code>
</div>
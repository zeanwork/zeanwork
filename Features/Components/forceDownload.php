<?php
/**
 * Contem a class ForceDownloadComponent 
 * 
...
class ForceDownloadComponent  extends Component {
	 ...
	 * @param string $file Nome/caminho do arquivo
	 */
    ...
    /**
     * Retorna o mime compatível com a extenção do arquivo
     * @param string $file Nome/caminho do arquivo
     */
     ...
     * @param string $file Nome/caminho do arquivo
     * @param string | boolean $newFileName Novo nome do arquivo (se false, salvará com mesmo nome)
     */
    public function download($file, $newFileName = false){
		$mimeType = $this->getMime($file);
		$browser = Util::getBrowser();
		
		if($newFileName == false)
			$newFileName = end(explode('/', $file));
			
		if(strpos($newFileName, '.') === false)
			$newFileName .= '.' . $this->getExtension($file);
